...
// @grant        none
// @updateURL    https://namesync.net/8chan/builds/NameSync.8chan.meta.js
// @downloadURL  https://namesync.net/8chan/builds/NameSync.8chan.user.js
...
.sync-post {\
  ...
  Sync = {
    ...
    sync: function () {
      ...
      $.xhr('GET', 'https://namesync.net/8chan/qp.php', $GET, function (c) {
        if (c.responseText !== '') {
    ...
    post: function (name, subject, email, thread, no) {
      ...
      $.xhr('POST', 'https://namesync.net/8chan/sp.php', $POST, function (c) {
    ...
    checkUpdate: function () {
      if (!g.checked) {
        ...
        $.xhr('GET', 'https://namesync.net/8chan/v.php', null, function (c) {
          var v;
  ...
  Tripfag_Finder = {
    ...
    updateThreads: function () {
      ...
      $.xhr('POST', 'https://www.namesync.net/finder/api.php', $POST, function(c) {
        var finder, threads;
  ...
  (function(open) {
    XMLHttpRequest.prototype.open = function(method, url, async, user, pass) {
      var _ref;
      if (method === 'POST' && url.indexOf("post.php") > -1) {
